...
举一反三：
1. 从搜索空间上看本题是一道一维DFS题目，之所以实现简单，是因为满足了贪心，可以大规模剪枝。
2. 如果修改数组为二维，并且0表示空地，可种下的花有多种如1/2/3/4/5，限制条件更加多样化，如要想种下2花必须在相邻位置种下3花，而4/5不能相邻等，问最多可以种多少棵花，或者问能否再种下[2,2,5,6,1]个每类花，共有多少种不同的方案，则本题就是标准的二维DFS问题了。
"""
